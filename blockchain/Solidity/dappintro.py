...
contracts = {
	...
	# address, above.
	'poll': '0xdD84E03Ab64D96B048EBB093293589556C5f4023',
...
other = {
	...
	'txn_hash_vote_yours': "0xc2f75b153c6f16371c511c7ca7d427cba2a127c85d8e401921e7825f84ccc3a6",

	# This is the transaction hash where you voted on the course Polls
	# contract in part 5 (vote) of the assignment.
	'txn_hash_vote_course': "0xd47443556431e2c44bd1d7a68d012c6fea48d60fe50bbc63b29892fb137458e9",
...
comments = {
	...
	'suggestions': "Is there any why to hid the private infomation in a differnt location? The collab landing page gets cluttered. Or maube just use bold to indicate the assigment?",
